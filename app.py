...
def main():
    ...
    if page == "Home":
        ...
        def load_and_merge_data():
            reviews = pd.read_csv("olist_order_reviews_dataset.csv\olist_order_reviews_dataset.csv")
            items = pd.read_csv("olist_order_items_dataset.csv\olist_order_items_dataset.csv")
            products = pd.read_csv("olist_products_dataset.csv\olist_products_dataset.csv")
